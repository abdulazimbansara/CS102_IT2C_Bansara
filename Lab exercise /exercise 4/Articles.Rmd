...
```{r}
url <- 'https://arxiv.org/search/?query=ai&searchtype=all&abstracts=show&order=-announced_date_first&size=50&start=0'
...
# saving data to R data and csv file

save(papers, file = "Arxiv_ai.RData")
write.csv(papers, file = "Arxiv_paperAI.csv")
